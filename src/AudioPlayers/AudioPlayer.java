...
import net.cursedmodder.javatriggers.audio.decoder.ugen.Glide;
        ...
        if(fade) {
            ...
            new Thread(() -> {
                ...
                Minecraft.getInstance().execute(() -> {
                    ...
                    player.patch(gain); //Split into different layers for easier debugging
                    gain.patch(lpf);
                    lpf.patch(summer);
            ...
            new Thread(() -> {
                ...
                Minecraft.getInstance().execute(() -> {
                    ...
                    AudioLogger.info("Starting song " + this.song.getSongName());
